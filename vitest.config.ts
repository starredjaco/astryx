    ...
    projects: [
      {
        ...
        test: {
          ...
          include: [
            ...
            'packages/astryx-formisch/src/**/*.test.{ts,tsx,mjs}',
            'packages/astryx-tanstack/src/**/*.test.{ts,tsx,mjs}',
            'packages/astryx-rhf/src/**/*.test.{ts,tsx,mjs}',
          ],
        },
      },
      {
        ...
        test: {
          ...
          exclude: [
            ...
            'packages/lab/**',
            'packages/formentor/**',
            'packages/astryx-formisch/**',
            'packages/astryx-tanstack/**',
            'packages/astryx-rhf/**',
          ],
        },
      },
