...
export const y2kTheme = defineTheme({
  ...
  tokens: {
    ...
    '--color-border-emphasized': ['#675d52', '#5b5146'],
...
export const y2kPalettes = {
  neutral: {
    hue: 75, chroma: 8,
    0: '#000000', 5: '#190f00', 10: '#221a10', 15: '#2d241b', 20: '#382f25',
    25: '#433a30', 30: '#4f453b', 35: '#5b5146', 40: '#675d52', 45: '#73695e',
    50: '#80756a', 55: '#8d8276', 60: '#9a8f83', 65: '#a79c90', 70: '#b5a99d',
    75: '#c3b7ab', 80: '#d1c5b8', 85: '#dfd2c6', 90: '#ede0d4', 95: '#fbefe2',
    100: '#ffffff',
  },
  green: {
    hue: 120, chroma: 60,
    0: '#000000', 5: '#061800', 10: '#132200', 15: '#152d00', 20: '#173900',
    25: '#1e4500', 30: '#285100', 35: '#355d00', 40: '#426900', 45: '#4f7600',
    50: '#5c830b', 55: '#69901d', 60: '#779d2c', 65: '#84aa39', 70: '#92b847',
    75: '#a0c654', 80: '#aed461', 85: '#bce26e', 90: '#caf07b', 95: '#d9fe89',
    100: '#ffffff',
  },
  red: {
    hue: 25, chroma: 55,
    0: '#000000', 5: '#480000', 10: '#540000', 15: '#620002', 20: '#700012',
    25: '#7f001b', 30: '#8e1126', 35: '#9c2330', 40: '#ab313b', 45: '#ba3f47',
    50: '#c94d52', 55: '#d95b5e', 60: '#e8686b', 65: '#f87677', 70: '#ff8787',
    75: '#ff9d9b', 80: '#ffb2af', 85: '#ffc6c3', 90: '#ffd9d7', 95: '#ffeceb',
    100: '#ffffff',
  },
  yellow: {
    hue: 85, chroma: 65,
    0: '#000000', 5: '#270c00', 10: '#301800', 15: '#3b2200', 20: '#472c00',
    25: '#533700', 30: '#604200', 35: '#6d4d00', 40: '#7b5900', 45: '#896500',
    50: '#977100', 55: '#a67e00', 60: '#b58b01', 65: '#c39819', 70: '#d2a52a',
    75: '#e2b239', 80: '#f1c047', 85: '#ffcd55', 90: '#ffde9b', 95: '#ffeecf',
    100: '#ffffff',
  },
  blue: {
    hue: 250, chroma: 40,
    0: '#000000', 5: '#001939', 10: '#002244', 15: '#002c4d', 20: '#003759',
    25: '#004266', 30: '#004e74', 35: '#005a83', 40: '#006693', 45: '#0073a3',
    50: '#0080b4', 55: '#008ec4', 60: '#0e9bd2', 65: '#2fa8e0', 70: '#45b6ef',
    75: '#57c3fd', 80: '#7ed0ff', 85: '#a3dbff', 90: '#c4e7ff', 95: '#e1f3ff',
    100: '#ffffff',
  },
  pink: {
    hue: 350, chroma: 45,
    0: '#000000', 5: '#3d001d', 10: '#490027', 15: '#560032', 20: '#64003d',
    25: '#711248', 30: '#7f2154', 35: '#8c2f60', 40: '#9a3c6c', 45: '#a84979',
    50: '#b75685', 55: '#c56392', 60: '#d371a0', 65: '#e27ead', 70: '#f18bbb',
    75: '#ff99c8', 80: '#ffaed3', 85: '#ffc3de', 90: '#ffd7e9', 95: '#ffebf4',
    100: '#ffffff',
  },
  purple: {
    hue: 300, chroma: 40,
    0: '#000000', 5: '#020840', 10: '#11144b', 15: '#1f1e57', 20: '#2c2864',
    25: '#393370', 30: '#453e7d', 35: '#524a8a', 40: '#5f5697', 45: '#6c62a4',
    50: '#796eb2', 55: '#867bc0', 60: '#9387ce', 65: '#a194dc', 70: '#afa2ea',
    75: '#bdaff8', 80: '#cbbeff', 85: '#d9ceff', 90: '#e6deff', 95: '#f3eeff',
    100: '#ffffff',
  },
  cyan: {
    hue: 185, chroma: 35,
    0: '#000000', 5: '#001e14', 10: '#00261f', 15: '#003029', 20: '#003b34',
    25: '#00473f', 30: '#00534a', 35: '#005f56', 40: '#006c62', 45: '#00796f',
    50: '#00867b', 55: '#0f9488', 60: '#29a195', 65: '#3bafa2', 70: '#4cbcb0',
    75: '#5bcabd', 80: '#6ad8cb', 85: '#79e7d9', 90: '#87f5e7', 95: '#a6fff5',
    100: '#ffffff',
  },
  orange: {
    hue: 60, chroma: 60,
    0: '#000000', 5: '#340000', 10: '#420500', 15: '#520b00', 20: '#601700',
    25: '#6d2400', 30: '#7b3000', 35: '#893c00', 40: '#984800', 45: '#a75409',
    50: '#b66019', 55: '#c56d26', 60: '#d47a33', 65: '#e48740', 70: '#f3944c',
    75: '#ffa25c', 80: '#ffb682', 85: '#ffc9a3', 90: '#ffdbc3', 95: '#ffede1',
    100: '#ffffff',
  },
  teal: {
    hue: 165, chroma: 30,
    0: '#000000', 5: '#001d00', 10: '#00240f', 15: '#002f1a', 20: '#003a24',
    25: '#00462f', 30: '#00513a', 35: '#115e45', 40: '#226a51', 45: '#30775d',
    50: '#3d8469', 55: '#4a9175', 60: '#589e82', 65: '#65ab8f', 70: '#72b99c',
    75: '#7fc7a9', 80: '#8dd5b7', 85: '#9be3c5', 90: '#a9f2d3', 95: '#b6ffe1',
    100: '#ffffff',
  },
} as const;
