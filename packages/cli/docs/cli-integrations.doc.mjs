  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          id: 'cli-integrations-b15',
          type: 'code',
          lang: 'jsonc',
          code: '{\n  "exports": {\n    // ...\n    "./templates/*.tsx": "./templates/*.tsx"\n  }\n}',
        },
        {
          id: 'cli-integrations-b16',
          type: 'prose',
