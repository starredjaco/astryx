...
/**
 * @file XDSMetadataList.tsx
 * @input Uses React, ReactNode, StyleXStyles, theme tokens, XDSMetadataListContext
 * @output Exports XDSMetadataList component, XDSMetadataListProps, XDSMetadataListColumns types
 * @position Core implementation; consumed by index.ts, tested by XDSMetadataList.test.tsx
 *
...
> {
  ...
  /**
   * Metadata list items. Should be XDSMetadataListItem components.
   */
  children: ReactNode;
  /**
   * Column layout mode.
   ...
   * @default 'single'
   */
  columns?: XDSMetadataListColumns;
  /**
   ...
   */
  label?: XDSMetadataListLabelConfig;
  /**
 ...
 * ```
 */
const LABEL_START: XDSMetadataListLabelConfig = {position: 'start'};
const LABEL_TOP: XDSMetadataListLabelConfig = {position: 'top'};

export function XDSMetadataList({
  children,
  columns = 'single',
  label,
  maxNumOfItems,
...
XDSMetadataList.displayName = 'XDSMetadataList';
