...
describe('XDSText', () => {
  describe('rendering', () => {
    ...
    it('renders as paragraph when as="p"', () => {
      render(<XDSText type="body" as="p">Paragraph</XDSText>);
      const element = screen.getByText('Paragraph');
      expect(element.tagName).toBe('P');
    });

    it('renders as div when as="div"', () => {
      render(<XDSText type="body" as="div">Div</XDSText>);
      const element = screen.getByText('Div');
      expect(element.tagName).toBe('DIV');
    });

    it('renders as label when as="label"', () => {
      render(<XDSText type="body" as="label">Label</XDSText>);
  ...
  describe('props', () => {
    it('forwards additional props', () => {
      render(<XDSText type="body" data-testid="custom-text">Text</XDSText>);
