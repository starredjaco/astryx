...
export const docs = {
  ...
  usage: {
    ...
    anatomy: [
      {name: 'Button', required: true, description: 'One or more XDSButton or XDSIconButton children that form the connected group.'},
...
export const docsZh = {
  ...
  usage: {
    ...
    anatomy: [
      {name: '按钮', required: true, description: '一个或多个 XDSButton 或 XDSIconButton 子元素，形成连接的组。'},
