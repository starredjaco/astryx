  ...
  components: [
    {
      ...
      props: [
        ...
        {name: 'emptyState', type: 'ReactNode', description: 'Content shown when the list has no messages.',
          slotElements: [{__element: 'XDSEmptyState', props: {title: 'No items', description: 'Nothing to show.'}}],
        },
    ...
    },
    {
      ...
      description: 'Sender context wrapper that handles avatar, name, metadata, and alignment based on sender role.',
      props: [
        ...
        {name: 'avatar', type: 'ReactNode', description: 'Avatar element rendered beside the message. Typically XDSAvatar.',
          slotElements: [{__element: 'XDSAvatar', props: {name: 'User', size: 'sm'}}],
        },
        ...
        {name: 'metadata', type: 'ReactNode', description: 'Metadata rendered below the message body. Use when the last child is raw content (not a bubble). If the last child is a bubble, put metadata on the bubble\'s `metadata` prop instead.',
          slotElements: [{__element: 'XDSText', props: {type: 'body'}, children: 'Metadata'}],
        },
    ...
    },
    {
      ...
      props: [
        {name: 'timestamp', type: 'ReactNode', description: 'Timestamp content: a string or XDSTimestamp component.',
          slotElements: [{__element: 'XDSText', props: {type: 'body'}, children: 'Just now'}],
        },
    ...
    },
    {
      ...
      props: [
        ...
        {name: 'drawer', type: 'ReactNode', description: 'Slot: collapsible drawer above the input for attachments, context chips, etc. Use XDSChatComposerDrawer.',
          slotElements: [{__element: 'XDSText', props: {type: 'body'}, children: 'Drawer content'}],
        },
        ...
        {name: 'headerContext', type: 'ReactNode', description: 'Slot: right-aligned contextual info in the header (context window usage, XDSProgressBar, supporting text).',
          slotElements: [{__element: 'XDSText', props: {type: 'body'}, children: 'Context'}],
        },
  ...
  components: [
    ...
    },
    {
      ...
      propDescriptions: {
        ...
        isDisabled: '禁用编写器。',
        density: '视觉密度。',
        drawer: '插槽：输入上方的可折叠抽屉，用于附件、上下文标签等。使用 XDSChatComposerDrawer。',
  ...
  components: [
    ...
    },
    {
      ...
      propDescriptions: {
        ...
        drawer: 'slot: collapsible drawer above input for attachments, context chips, etc.; use XDSChatComposerDrawer',
