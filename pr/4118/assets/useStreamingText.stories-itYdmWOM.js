import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./Text-c5LWyKai.js";import{t as i}from"./jsx-runtime-cM__dR4X.js";import{t as a}from"./Button-D16xsf4E.js";import{t as o}from"./Button-Ncr6y4Fk.js";import{t as s}from"./hooks-NzPD7P0G.js";import{n as c}from"./useStreamingText-DQs9oost.js";import{i as l}from"./Stack-mterni5z.js";import{t as u}from"./Layout-BbT8IvUw.js";import{t as d}from"./Text-_h16ESYs.js";function f({text:e,speed:t,chunkSize:n,chunkIntervalMs:i}){let[o,s]=(0,p.useState)(``),[u,d]=(0,p.useState)(!1),f=(0,p.useRef)(0),h=(0,p.useRef)(null),g=c(o,u,{speed:t}),_=(0,p.useCallback)(()=>{h.current&&clearInterval(h.current),f.current=0,s(``),d(!0),h.current=setInterval(()=>{f.current=Math.min(f.current+n,e.length),s(e.slice(0,f.current)),f.current>=e.length&&(h.current&&clearInterval(h.current),h.current=null,setTimeout(()=>d(!1),200))},i)},[e,n,i]);return(0,p.useEffect)(()=>()=>{h.current&&clearInterval(h.current)},[]),(0,m.jsxs)(l,{gap:4,children:[(0,m.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`},children:[(0,m.jsx)(a,{label:u?`Streaming...`:`Start`,onClick:_,variant:u?`secondary`:`primary`,isDisabled:u}),(0,m.jsxs)(r,{type:`supporting`,children:[`speed: `,t,` · chunk: `,n,` chars every `,i,`ms`]})]}),(0,m.jsx)(`div`,{style:{padding:16,borderRadius:8,background:`var(--color-background-muted)`,minHeight:80,whiteSpace:`pre-wrap`,fontFamily:`var(--font-family-body)`},children:(0,m.jsx)(r,{type:`body`,children:g||`\xA0`})}),(0,m.jsxs)(r,{type:`supporting`,children:[g.length,` / `,o.length,` chars displayed`,u?` · streaming`:o.length>0?` · done`:``]})]})}var p,m,h,g,_,v,y,b,x,S;t((()=>{p=e(n()),s(),d(),o(),u(),m=i(),h=`Here is how you fetch a user in TypeScript:
